...
def set_value_map(new_map, mode):
    ...
    global value_map, n_classes, mapping_mode
    value_map = new_map
...
def main():
    ...
    parser.add_argument('--train_dir', type=str, default=os.path.join(script_dir, '..', 'Offroad_Segmentation_Training_Dataset', 'train'))
    parser.add_argument('--val_dir', type=str, default=os.path.join(script_dir, '..', 'Offroad_Segmentation_Training_Dataset', 'val'))
    parser.add_argument('--output_dir', type=str, default=os.path.join(script_dir, 'train_stats'))
    ...
    parser.add_argument('--backbone_size', type=str, default='small', choices=['small', 'base', 'large', 'giant'])
